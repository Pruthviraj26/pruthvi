...
Router::prefix('admin', ['_namePrefix' => 'admin:'], function ($routes) {
	...
	Router::scope('/products',['controller'=>'products'], function (RouteBuilder $routes) {
		
	});
								
	Router::scope('/currency',['controller'=>'currency'], function (RouteBuilder $routes) {
	...
	$routes->connect('/home', ['controller'=>'pages','action' => 'home'], ['routeClass' => 'DashedRoute']);	
		...
		$routes->connect('/posttype/menu/add', ['controller'=>'menu','action' => 'add','posttype'], ['routeClass' => 'DashedRoute']);
	
	$routes->connect('/posttype/:posttype/edit/:id', ['controller'=>'post','action' => 'add','posttype','id'], ['routeClass' => 'DashedRoute']);
	$routes->connect('/posttype/:posttype/add', ['controller'=>'post','action' => 'add','posttype'], ['routeClass' => 'DashedRoute']);
	$routes->connect('/posttype/:posttype', ['controller'=>'post','action' => 'index','posttype'], ['routeClass' => 'DashedRoute']);
	
	
	$routes->connect('/posttype/:posttype/texonomy/:texonomy/edit/:id', ['controller'=>'terms','action' => 'add','posttype','texonomy','id'], 
									 ['routeClass' => 'DashedRoute']);
	
	$routes->connect('/posttype/:posttype/texonomy/:texonomy', ['controller'=>'terms','action' => 'index','posttype','texonomy'], ['routeClass' => 'DashedRoute']);
...
Router::scope('/api', function (RouteBuilder $routes) {
 		...
 		$routes->connect('/admin', ['controller' => 'Pages', 'action' => 'home','prefix' => 'admin'], ['routeClass' => 'DashedRoute']);	
	  $routes->connect('/', ['controller' => 'Pages', 'action' => 'home', 'home','prefix' => 'api']);	
		$routes->connect('/:controller/get/:id', ['action' => 'get','id','prefix' => 'api'], ['routeClass' => 'DashedRoute']);
		
		$routes->connect('/:action', ['controller' => 'Pages','prefix' => 'api'], ['routeClass' => 'DashedRoute']);
  	$routes->connect('/:controller/:action/*', ['prefix' => 'api'], ['routeClass' => 'DashedRoute']);
		
		$routes->connect('/cards/:status/:id', ['controller'=>'cards','action'=>'changestatus','prefix' => 'api','status','id'], ['routeClass' => 'DashedRoute']);
		$routes->connect('/cards/delete/:id', ['controller'=>'cards','action'=>'delete','prefix' => 'api','status','id'], ['routeClass' => 'DashedRoute']);
