...
Router::prefix('admin', ['_namePrefix' => 'admin:'], function ($routes) {
	...
	Router::scope('/cards',['controller'=>'cards'], function (RouteBuilder $routes) {
	...
	$routes->connect('/users/type/:type', ['controller'=>'users','action' => 'index','type'], ['routeClass' => 'DashedRoute']);						
...
Router::scope('/', function (RouteBuilder $routes) {
	  ...
	  $routes->connect('/', ['controller' => 'Pages', 'action' => 'home', 'home','prefix' => 'front']);	
  	...
  	$routes->connect('/:controller/:action/*', ['prefix' => 'front'], ['routeClass' => 'DashedRoute']);	
		$routes->connect('/cards/:status/:id', ['controller'=>'cards','action'=>'statuschange','prefix' => 'front','status','id'], ['routeClass' => 'DashedRoute']);
