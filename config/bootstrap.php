...
$allowedHost = ['localhost','192.168.1.171'];
...
Plugin::load($front_theme, ['bootstrap' => false]);
Configure::load($front_theme.'Config','default');

//Plugin::load('demo', ['initConfig'=>true,'bootstrap' => true]);
